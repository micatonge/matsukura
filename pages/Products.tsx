            ...
            <Grid item xs={12} sm={6} md={4}>
              <ProductCard
                product={{
                  name: "Eyeglasses 1",
                  description:
                    "Stylish and comfortable eyeglasses with a modern design.",
                  price: 10000,
            ...
            <Grid item xs={12} sm={6} md={4}>
              <ProductCard
                product={{
                  name: "Sunglasses 1",
                  description:
                    "Protect your eyes in style with these premium sunglasses.",
                  price: 12000,
            ...
            <Grid item xs={12} sm={6} md={4}>
              <ProductCard
                product={{
                  name: "Eyeglasses 2",
                  description:
                    "Classic eyeglasses with a timeless look and feel.",
                  price: 9000,
