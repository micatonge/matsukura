  ...
  return (
    <div className="container">
      <Head>
        ...
        <meta name="description" content="Learn more about Matsukura Eyewear and our services" />
      </Head>

      <Box sx={{ marginTop: 4, marginBottom: 4, marginX: 'auto', maxWidth: '1200px' }}>
        {/* Title */}
        <Typography variant="h3" component="h1" gutterBottom align="left" sx={{ color: '#2c3e50' }}>
          About Matsukura Eyewear
        </Typography>

        {/* Intro Paragraph */}
        <Typography variant="body1" paragraph align="left" sx={{ color: '#34495e', fontSize: '1rem' }}>
          Welcome to Matsukura Eyewear, where we provide high-quality eyewear solutions tailored to your needs.
          We are proud to offer a variety of eyewear and hearing aid consultations. Our stores carry a range of stylish frames
          and high-end lenses at affordable prices.
        </Typography>
        ...
        {/* Services Section */}
        <Typography variant="h4" gutterBottom align="left" sx={{ color: '#00000' }}>
          Our Services
        </Typography>
          ...
          <Grid item xs={12} md={6}>
            <Card sx={{ height: '100%', backgroundColor: '#fefae0' }}>
              <CardContent>
                ...
                <Button variant="contained" href="https://matsukura-megane.co.jp/yata/" target="_blank" fullWidth sx={{ backgroundColor: '#283618', color: '#fff', '&:hover': { backgroundColor: '#606c38' } }}>
                  Learn More
                </Button>
              </CardContent>
            </Card>
        ...
        <Typography variant="h4" gutterBottom align="left" sx={{ color: '#2c3e50' }}>
          Store Information
        </Typography>
        <Grid container spacing={4}>
          <Grid item xs={12} md={4}>
            <Card sx={{ height: '100%', backgroundColor: '#fefae0' }}>
              <CardContent>
                ...
                <Typography variant="body2" paragraph sx={{ color: '#34495e' }}>
                  We offer a variety of frames, including single-vision glasses starting from ¥6600 for 3 pairs.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ height: '100%', backgroundColor: '#fefae0' }}>
              <CardContent>
                ...
                <Typography variant="body2" paragraph sx={{ color: '#34495e' }}>
                  Website: <a href="https://www.rakuten.ne.jp/gold/glass-m-shop/" target="_blank" style={{ color: '#606c38' }}>Visit our Rakuten Shop</a>
                  <br />
                  Phone: 06-6654-3142
                  <br />
                  Regular Hours: 10:00 AM - 6:00 PM
